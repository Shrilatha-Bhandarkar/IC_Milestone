...
//   try {
//     const {id,foodTitle,fooddescription,foodprice,foodimage}=req.body
//     if (req.body) {
//     const newfood=new food({id,foodTitle,fooddescription,foodId,foodprice,foodimage,vegnonveg})
//     await newblog.save();
...
//   app.get('/Order/:foodId',async(req,res)=>{
//   try { 
//      const foodId=req.params.foodId;
//      const cachedData=cache.get(foodId);
...
//       _id:"$foodId",
//       totalBlogs:{$sum:1},
//       blogTitle:{$first:'$foodTitle'},
//       avgBlogLength:{$avg:{$strLenCP:"$fooddescription"}}
//     },
//   },
//   {
//   $sort:{
...
//   cache.set(foodId, aggregateData, 60);
...
//     try {  
//         if (req.body) {
//             await Blog.findOneAndUpdate({foodId:req.params.id},req.body);
//         }
//           res.json('updated');
//     } catch (error) {
//       console.error('Error fetching notes:', error);
